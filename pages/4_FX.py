...
st.set_page_config(page_title="FX", page_icon="📈")

st.title("FX Strategy ")
...
#tickers data
ticker=st.text_input('Ticker','EURUSD=X,JPY=X')
ticker=ticker.split(",")

print(ticker)

def fxswing(item,startdate):
    all_d=pd.DataFrame()
...
st.header('**Currencies Data**')

allof=fxswing(ticker,start_date)
...
st.sidebar.header("Forex Strategy")
